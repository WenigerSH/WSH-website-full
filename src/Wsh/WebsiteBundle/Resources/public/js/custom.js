...
jQuery(document).ready(function($) {
	...
	(function() {
		...
		var $form   = $('form.contact-form'),
			$loader = '<img src="/bundles/wshwebsite/img/loader.gif" height="11" width="16" alt="Loading..." />';

		$form.after('<div id="response" class="hidden">');
		...
		$form.on('submit', function(e){
			...
			$.post($form.attr("action"), $form.serialize(), function( data ) {
                ...
                if (data.status == 1) {
                    ...
                    $response.html( '<p class="info">' + data.message + '</p>' );
                }
